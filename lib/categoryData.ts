...
export const categories: Category[] = [
    ...
    },
    {
        ...
        subsubcategories: {
            "Women's Jwellery": ["Pendants", "Necklace & Chains", "Rings", "Bracelets", "Waist Chains", "Anklets", "Chains & Charms", "Earrings", "Bangles", "Jwellery Sets"],
            "Men's Jwellery": ["Rings", "Chains & Pendants", "Bracelets", "Earrings"],
